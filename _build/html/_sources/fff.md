...
And what is punctuated with a `$` sign (e.g. `$datafile` or `${datafile}') is a global macro
...
But in other scenarios local macros will be automatically generated by Stata 
